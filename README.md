...
- **Sorting algorithms**: [Bubble Sort](./sorting_algorithms/bubble_sort.py), [Topological Sort](./topological_sort/topological_sort.py), [Merge Sort](./sorting_algorithms/merge_sort.py), [Insertion Sort](./sorting_algorithms/insertion_sort.py), [Selection Sort](./sorting_algorithms/selection_sort.py), [Quick Sort](./sorting_algorithms/quick_sort.py)
